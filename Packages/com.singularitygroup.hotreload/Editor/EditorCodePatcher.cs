...
namespace SingularityGroup.HotReload.Editor {
    ...
    static class EditorCodePatcher {
        ...
        public static bool LoginNotRequired => PackageConst.IsAssetStoreBuild && licenseType != UnityLicenseType.UnityPro;
        ...
        static void OnIntervalMainThread() {
            ...
            if(ServerHealthCheck.I.IsServerHealthy) {
                RequestHelper.PollMethodPatches(HandleResponseReceived);
