...
namespace SingularityGroup.HotReload.Editor {
    internal static class HotReloadWindowStyles {
        ...
        public static GUIStyle H3CenteredTitleStyle {
            get {
                if (h3CenterTitleStyle == null) {
                    ...
                    h3CenterTitleStyle.padding.top = 5;
                    h3CenterTitleStyle.padding.bottom = 5;
                }
        ...
        public static GUIStyle ChangelogPointerStyle {
            get {
                var changelogPointersStyle = new GUIStyle();
                changelogPointersStyle.wordWrap = true;
                changelogPointersStyle.normal.textColor = new Color(50, 50, 50, 0.6f);
    ...
    internal static class HotReloadWindowOptions {
        private static GUILayoutOption[] expandHightOnly;

        public static GUILayoutOption[] ExpandHightOnly => expandHightOnly ?? (expandHightOnly = new[] {
