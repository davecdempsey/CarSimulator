...
namespace SingularityGroup.HotReload.Editor {
    internal class HotReloadSettingsTab : HotReloadTabBase {
        ...
        public override void OnGUI() {
            ...
            if (RenderLicenseInfoSection()) {
                EditorGUILayout.Space();
            }
            
            if (RenderPromoCodeSection()) {
                EditorGUILayout.Space();
            }
        ...
        void RenderAssetRefresh() {
            ...
            if (newSettings != HotReloadPrefs.AllAssetChanges) {
                ...
                if (ServerHealthCheck.I.IsServerHealthy) {
                    HotReloadCli.RestartAsync(HotReloadPrefs.ExposeServerToLocalNetwork, newSettings).Forget();
                }
            }
            string toggleDescription;
        ...
        private bool RenderLicenseInfoSection() {
        ...
        private bool RenderPromoCodeSection() {
            ...
            if (_window.runTab.TrialLicense && _window.runTab.Running) {
